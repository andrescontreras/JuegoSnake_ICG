...
loadCameraMatrix( )
{
  ...
  eyeX = m_Zoom * std::sin(m_AngleX * (_PI / 180)) * std::cos(m_AngleY * (_PI / 180));
  eyeY = m_Zoom * std::sin(m_AngleY * (_PI / 180));
  eyeZ = m_Zoom * std::cos(m_AngleX * (_PI / 180)) * std::cos(m_AngleY * (_PI / 180));
